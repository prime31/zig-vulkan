...
pub const ImVector_ImWchar = struct_ImVector_ImWchar; // cimgui.h:1177:18: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiIO = extern struct {
    ...
    SetPlatformImeDataFn: ?fn ([*c]ImGuiViewport, [*c]ImGuiPlatformImeData) callconv(.C) void,
...
pub const ImGuiViewportP = struct_ImGuiViewportP; // cimgui.h:2525:15: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiTabBar = struct_ImGuiTabBar; // cimgui.h:2023:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiTableDrawChannelIdx = ImU8; // cimgui.h:2682:10: warning: struct demoted to opaque type - has bitfield
...
pub const ImSpan_ImGuiTableCellData = struct_ImSpan_ImGuiTableCellData; // cimgui.h:2727:24: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiContext = extern struct {
    ...
    ActiveIdUsingKeyInputMask: ImBitArrayForNamedKeys,
...
pub const ImGuiOnceUponAFrame = struct_ImGuiOnceUponAFrame; // cimgui.h:990:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiInputEventType_Char: c_int = 6;
...
pub const ImVector_ImGuiTableColumnSortSpecs = struct_ImVector_ImGuiTableColumnSortSpecs; // cimgui.h:2830:10: warning: struct demoted to opaque type - has bitfield
...
pub extern fn igImQsort(base: ?*anyopaque, count: usize, size_of_element: usize, compare_func: ?fn (?*const anyopaque, ?*const anyopaque) callconv(.C) c_int) void;
