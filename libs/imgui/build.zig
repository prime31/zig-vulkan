...
pub fn linkArtifact(_: *Builder, exe: *std.build.LibExeObjStep, target: std.zig.CrossTarget, comptime prefix_path: []const u8) void {
    ...
    const cpp_args = [_][]const u8{"-Wno-return-type-c-linkage", "-DIMGUI_IMPL_API=extern \"C\"", "-Wall", "-DIMGUI_DISABLE_OBSOLETE_FUNCTIONS=1"};
    ...
    const cpp_args2 = [_][]const u8{"-Wno-return-type-c-linkage", "-DIMGUI_IMPL_API=extern \"C\"", "-DCIMGUI_DEFINE_ENUMS_AND_STRUCTS=1"};
