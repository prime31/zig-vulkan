...
extern fn _ogImDrawList_AddTriangleFilled(self: [*c]imgui.ImDrawList, tl: *const imgui.ImVec2, bl: *const imgui.ImVec2, br: *const imgui.ImVec2, col: imgui.ImU32) void;
...
extern fn _ogImDrawList_AddImage(self: [*c]imgui.ImDrawList, user_texture_id: imgui.ImTextureID, p_min: *const imgui.ImVec2, p_max: *const imgui.ImVec2, uv_min: *const imgui.ImVec2, uv_max: *const imgui.ImVec2, col: imgui.ImU32) void;
extern fn _ogSetCursorScreenPos(pos: *const imgui.ImVec2) void;
extern fn _ogBeginChildID(id: imgui.ImGuiID, size: *const imgui.ImVec2, border: bool, flags: imgui.ImGuiWindowFlags) bool;
...
pub fn ogCalcTextSize(text: [*c]const u8, text_end: [*c]const u8, hide_text_after_double_hash: bool, wrap_width: f32) imgui.ImVec2 {
    var size = imgui.ImVec2{};
    imgui.CalcTextSize(&size, text, text_end, hide_text_after_double_hash, wrap_width);
    return size;
}
...
pub fn ogImDrawList_AddTriangleFilled(draw_list: [*c]imgui.ImDrawList, tl: imgui.ImVec2, bl: imgui.ImVec2, br: imgui.ImVec2, col: imgui.ImU32) void {
    _ogImDrawList_AddTriangleFilled(draw_list, &tl, &bl, &br, col);
}
...
pub fn ogImDrawList_AddImage(draw_list: [*c]imgui.ImDrawList, user_texture_id: imgui.ImTextureID, p_min: imgui.ImVec2, p_max: imgui.ImVec2, uv_min: imgui.ImVec2, uv_max: imgui.ImVec2, col: imgui.ImU32) void {
    _ogImDrawList_AddImage(draw_list, user_texture_id, &p_min, &p_max, &uv_min, &uv_max, col);
}
...
pub fn ogBeginChildID(id: imgui.ImGuiID, size: imgui.ImVec2, border: bool, flags: imgui.ImGuiWindowFlags) bool {
